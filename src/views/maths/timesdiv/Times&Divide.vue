    ...
    export default {
        ...
        methods: {
            generateQuestion() {
                ...
                this.btnData[0].answer = this.generateRandomNumber(correctAnswer / 2, correctAnswer * 2, correctAnswer);
                this.btnData[0].correct = false;
                this.btnData[1].answer = this.generateRandomNumber(correctAnswer / 2, correctAnswer * 2, correctAnswer);
                this.btnData[1].correct = false;
                this.btnData[2].answer = this.generateRandomNumber(correctAnswer / 2, correctAnswer * 2, correctAnswer);
                this.btnData[2].correct = false;
                this.btnData[3].answer = this.generateRandomNumber(correctAnswer / 2, correctAnswer * 2, correctAnswer);
