  ...
  <div id="welcome">
    <div v-if="loggedIn">
      ...
      <div class="homebord">
        ...
        <p style="font-size:25px; line-height:55px; margin-top: 2px;"><strong>Colour</strong> is the property possessed by an object of producing different sensations on the eye as a result of the way it reflects or emits light. This app has some cool colours which you can play with, which will also display any colour you need to know about. Know your colours with ease by clicking <a href="/colors" style="text-decoration: none">LearnNow Colours</a> to see some fantastic colours we have. It will be fun all through as you get to know the kinds of colour we have.</p>
      </div>
      <div class="homebord">
        <h2 style="text-align:center; text-decoration:underline; margin-bottom: 0px">Alphabets</h2>
        <p style="font-size:25px; line-height:55px"><strong>Alphabets</strong> are a set of letters or symbols in a fixed order used to represent the basic set of speech sounds of a language, which consists of a set of letters from A to Z. The LearnNow Alphabets is basically for nursery school students which displays the capital letters, small letters, vowels and consonants for them to study. Know your alphabets with ease by clicking <a href="/alphabet" style="text-decoration: none">Alphabets</a> under the English section to know the various alphabets we have. It will be fun all through as you get to know the Alphabets.</p>
      </div>
      <div class="homebord">
        <h2 style="text-align:center; text-decoration:underline; margin-bottom: 0px">EngWords</h2>
        <p style="font-size:25px; line-height:55px"><strong>EngWords</strong> stands for English Words. LearnNow English Words helps you learn new words and most common words in english. It also allows you to study the words and try to spell them offhand so as to improve your vocabulary and explore language. Know your english words with ease by clicking <a href="/engQuiz" style="text-decoration: none">EngWords</a> under the English section to know the various english words we have. It will be fun all through as you get to know the English words.</p>
      </div>
      <div class="homebord">
      ...
      <div class="homebord">
        ...
        <p style="font-size:25px; line-height:55px"><strong>Arithmetic Operator</strong> is a mathematical function that takes two operands and perform a calculation on them. LearnNow Arithmetic Operator helps you learn how to add, subtract, divide and multiply numbers with ease. It lets you improve your calculations skill. Know your Arithmetic Operators with ease by clicking <a href="/arithmeticOperator" style="text-decoration: none">Arithmetic Operators</a> under the Maths section to know the basic arithmetic operators we have. It will be fun all through as you get to know them.</p>
      </div>
      <div class="homebord">
        <h2 style="text-align:center; text-decoration:underline; margin-bottom: 0px">Add&Minus</h2>
        <p style="font-size:25px; line-height:55px"><strong>Add&Minus</strong> stands for Addition and Subtraction. LearnNow Add&Minus helps you learn Addition and Sutraction of numbers with ease. It lets you play the LearnNow add and minus game that will improve your addition and subtraction skill. Know your addition and subtraction with ease by clicking <a href="/addMinus" style="text-decoration: none">Add&Minus</a> under the Maths section to play the addition and subtraction game. It will be fun all through as you get to know how to add and subtract numbers.</p>
      </div>
      <div class="homebord">
        <h2 style="text-align:center; text-decoration:underline; margin-bottom: 0px">Times&Divide</h2>
        <p style="font-size:25px; line-height:55px"><strong>Times&Divide</strong> stands for Multiplication and Division. LearnNow Times&Divide helps you learn Multiplication and Division of numbers with ease. It lets you play the LearnNow times and divide game that will improve your multiplication and division skill. Know your multiplication and division with ease by clicking <a href="/timesDivide" style="text-decoration: none">Times&Divide</a> under the Maths section to play the multiplication and division game. It will be fun all through as you get to know how to multiply and divide numbers.</p>
      </div>
      <div class="homebord">
        <h2 style="text-align:center; text-decoration:underline; margin-bottom: 0px">Calc</h2>
        <p style="font-size:25px; line-height:55px"><strong>Calc</strong> stands for calculator. Calculator is something that performs arithmetic operations on numbers, it could be a small electronic device with a keyboard and a visual display. It was invented by <strong>Jack Kilby</strong>. This app has some cool arithmetic functions you can play with. Test your calculator skills with ease by clicking <a href="/standardCalc" style="text-decoration: none">LearnNow Calc</a> to see some fantastic arithmetic functions we have. It will be fun all through as you get to know the basic arithmetic operations in action.</p>
      </div>
    </div>
