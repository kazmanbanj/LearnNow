    ...
    <form @submit.prevent="pressed">
      ...
      <div class="input" :class="{ invalid: $v.email.$error }">
        ...
        <input
          ...
          v-model="email"
        />
        <p id="pfont" v-if="!$v.email.email">
          Please provide a valid email address.
        </p>
        <p id="pfont" v-if="!$v.email.required">
      ...
      <div class="input" :class="{ invalid: $v.password.$error }">
        ...
        <input
          ...
          v-model="password"
        />
        <p id="pfont" v-if="$v.password.$error">
          Minimum of 6 characters is required for the password.
        </p>
      </div>
      <div class="input" :class="{ invalid: $v.confirmPassword.$error }">
        ...
        />
        <p id="pfont" v-if="$v.confirmPassword.$error">
          The password must match the password above.
        </p>
      </div>
      ...
      <div class="submit">
        <button type="submit" :disabled="$v.$invalid" class="submitbtn">
          Submit
        </button>
      </div>
    </form>
